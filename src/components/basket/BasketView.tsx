          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-3xl p-5 border border-stone-200/70 shadow-xs space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-sm text-stone-900">Sustituciones del prototipo</h3>
              </div>
              <p className="text-xs text-stone-600 leading-relaxed">
                Esta simulación muestra <strong>6 sustituciones ficticias</strong> por alternativas con mayor puntuación dentro del catálogo de demostración.
              </p>
              <div className="bg-stone-50 p-3 rounded-2xl border border-stone-200/50 text-xs text-stone-600">
                <em>Este resumen es ilustrativo y no evalúa tu dieta ni tus hábitos reales.</em>
              </div>
            </div>
          </div>
        )}
